...
class Creature {
     ...
     */
    Creature(const std::string& name, Category category = Category::CATEGORY_UNKNOWN , School school = School::SCHOOL_UNKNOWN, int health = 1, int level = 1, bool tame = false, int speed = 1);
